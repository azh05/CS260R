...
class TD3Trainer:
    ...
    def train(self, replay_buffer, batch_size=256):
        ...
        with torch.no_grad():
            ...
            next_action = (
                self.actor_target.forward(next_state) + noise
            ...
            q1_value, q2_value = self.critic_target.forward(next_state, next_action)

            target_Q = reward + self.discount * torch.min(q1_value, q2_value) * not_done
        ...
        if self.total_it % self.policy_freq == 0:
            ...
            # actor.
            actor_loss = -1 * self.critic.Q1(state, self.actor(state)).mean()
